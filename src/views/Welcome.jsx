        ...
        <Row className="justify-content-center m-v-space">
          <Col sm={8} className="main-card white-bg">
            <Row className="justify-content-center m-b-space">
              <Col sm={6}>
                <Image className="full-img" src={frontImg} alt="Books" />
              </Col>
            </Row>
              ...
              <Col sm={12}>
                <div className="full-card justify-text purple-bg white">
                  <p>
                    ...
                    RDD fue construido con el propósito de promover el
                    aprendizaje autónomo, así como de facilitar, enriquecer y
                    fortalecer los procesos de enseñanza-aprendizaje de la UA en
                    cuestión en la modalidad escolarizada.
                  </p>
                  <p>
                    ...
                    actividades de aprendizaje de acuerdo con las
                    especificaciones proporcionadas y en los tiempos
                    establecidos.
                  </p>
                  <p>

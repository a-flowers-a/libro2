            ...
            <Container fluid>
                ...
                <section id="2.3.1.1">
                    ...
                    <div className="justify-text">
                        ...
                        De acuerdo con las NIF A-5 un activo es “un recurso controlado por una entidad, identificado, cuantificado en términos monetarios, del que se espera fundamentalmente beneficios económicos futuros, derivado de operaciones ocurridas en el pasado, que han afectado económicamente a dicha entidad”.</p>
...
Las (NIF A-5) definen al pasivo como “es una obligación presente de una entidad, identificada, cuantificada en términos monetarios que representa una probable disminución de recursos económicos y derivados de operaciones ocurridas en el pasado, que han afectado económicamente a dicha entidad”.
                ...
                <div className="justify-text">
                    ...
                    <ol class="upper-letter">
                        <li><p className="bold">Estado de situación financiera en forma de Cuenta.</p> Tiene un formato horizontal, anotando en la parte izquierda el Activo y en la parte derecha el Pasivo y el Capital Contable. Se basa en la fórmula <p className="bold">A = P + CC</p> tal como se muestra en la figura 2.13</li>
                        <Row className="justify-content-center m-v-space">
                            <Col md={5}>
                    ...
                    <Row className="justify-content-center m-v-space">
                        ...
                        <Col md={6} className="v-center-content text-descrip">Estructura de situación financiera</Col>
                    </Row>
                    ...
                    <Row className="justify-content-center m-v-space">
                        <Col md={7}>
                            ...
                            <div className="img-source center-text">Contador Contado. (22 de agosto de 2018). Ley de la partida doble. Recuperado de https://www.youtube.com/watch?v=nilGlPwTx30&t=247s</div>
                        </Col>
                    </Row>

        ...
        <Container>
            ...
            <div className="justify-text">
              ...
              <ol className="upper-letter">
                <li>
                  ...
                  brindan a la sociedad bienes y servicios para la satisfacción
                  de necesidades humanas, siendo a la vez una fuente de empleo.
                </li>
                <li>
              ...
              <p>
                ...
                económico es el <p className="bold">Estado de resultados.</p>{" "}
                Éste nos da el dato de ¿cuánto ganamos o cuánto perdimos? en un
                período determinado (Figuras 2.15 y 2.16).
              </p>
              ...
              <p>
                ...
                estado financiero que muestra cómo se ha obtenido la utilidad o
                la pérdida del ejercicio de una entidad, durante un período
          ...
          <section id="2.3.2.2">
            ...
            <p>
              ...
              <p className="inline bold red">CUENTAS DE EGRESOS</p> (Figura
            ...
            <Table striped bordered size="sm">
              <tbody>
                <tr>
                  ...
                  <td>
                    <div className="bold">Ventas o ingresos netos.</div>{" "}
                    Ingresos derivados de la venta de mercancía y de la
                    prestación de servicios. El rubro VENTAS incluye las ventas
                    realizadas a crédito, así como las de contado.
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    ...
                    empresa le costó adquirir o producir la mercancía o
                    servicios que vendió.
                  </td>
                </tr>
                <tr>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <p>
                      <div className="bold">Gastos de administración.</div>{" "}
                      Gastos que se originan por llevar a cabo las funciones de
                      dirección y de administración.
                    </p>
                    <p>
                      <div className="bold">Otros ingresos.</div> Este rubro se
                      refiere a los ingresos que no se derivan de las
                      actividades normales (correspondientes al giro) ni
                      recurrentes de la entidad, por ejemplo: utilidad en venta
                      de activos, rentas recibidas, comisiones ganadas por
                      operaciones no financieras, donativos y cualquier otro
                      ingreso que no tenga una identificación específica (García
                      y Mendoza, 2013; Lara 2017).
                    </p>
                    <p>
                      ...
                      obsequios, pérdida en venta de active fijo y cualquier
                      gasto que no tenga una identificación específica”
                ...
                <tr>
                  <td>
                    <div className="bold">
                      <p>
                        ...
                        por ingresos y gastos relacionados con actividades de
                        tipo financiero
                      </p>
                      <p className="center-text no-marg-bottom">Incluye:</p>
                      <ul>
                  ...
                  <td>
                    <p>
                      ...
                      (comisiones bancarias) o de las cuentas por pagar
                    ...
                    <p>
                      ...
                      Por ejemplo, cuando se tienen cuentas bancarias, cuentas
                      por cobrar y/o por pagar en moneda extranjera.
                    </p>
                    <p>
                      <div className="bold">
                        Pérdida cambiaria. Pérdida generada por las
                        fluctuaciones en el tipo de cambio.
                      </div>{" "}
                      Por ejemplo, cuando se tienen cuentas bancarias, cuentas
                      por cobrar y/o por pagar en moneda extranjera.
                    ...
                    <p>
                      ...
                      los instrumentos financieros de capital, por ejemplo,
                      bonos o acciones, por las condiciones específicas del
                      mercado, la cual genera un resultado que puede ser
                      positivo o negativo para las empresas que tienen
                      invertidos sus excedentes en este tipo de instrumentos.
                    </p>
                    <p>
                      <div className="bold">
                        Resultado por posición monetaria (REPOMO).
                      </div>{" "}
                      Utilidad o pérdida que se obtiene al revaluar los activos
                      y pasivos monetarios por los efectos de la inflación.
                    </p>
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    Representa el importe que resulta de restar a los ingresos
                    los costos y gastos incluidos en el estado de resultados,
                    sin considerer aún los impuestos a la utilidad, las
                ...
                <tr>
                  <td>
                    <div className="bold">
                      Utilidad o pérdida de operaciones continuas (operaciones
                      de la empresa)
                    </div>
                  </td>
                  <td>
                    Es la suma algebraica de la utilidad o pérdida antes de
                    impuestos a la utilidad y el rubro de impuestos a la
                    utilidad. En caso de no existir operaciones discontinuadas,
                ...
                <tr>
                  ...
                  <td>
                    En este rubro deben presentarse los ingresos, costos y
                    gastos derivados de las operaciones discontinuadas. Debe
                    entenderse como operación discontinuada el proceso de
                    interrupción definitiva de una actividad de negocios
                    significativa de la entidad (NIF B-3).
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    ...
                    operaciones continuas y, en su caso, el rubro de operaciones
            ...
            <p>
              Como puede apreciarse los primeros rubros que conforman al estado
              de resultados son las ventas o ingresos y el costo de ventas,
              ambos estás estrechamente relacionados con los inventarios. En
              este sentido, el registro y control de inventarios (mercancías)
              cobra de gran relevancia.
            </p>
            <p>
            ...
            <p>
              Con el tema antes explicado, has concluido esta unidad temática.
              Te invitamos a contestar los reactivos de la siguiente evaluación.
            </p>
            <Row className="justify-content-center m-v-space">
              <Col md={3}>
                <Actividad

    ...
    return(
        <div className="primary-div">
            ...
            <Container fluid>
                ...
                <section id="2.2.1">
                    <Row><h3>2.2.1 Importancia de las Normas de Información Financiera (NIF)</h3></Row>
                    <Row className="justify-content-center m-v-space">
                        <Col md={9}>
                            ...
                            <Row className="justify-content-center v-center-content">
                                ...
                                <Col className="text-descrip">Importancia de la información financiera (infografía)</Col>
                            </Row>
                        </Col>
                        <Col md={3}>
